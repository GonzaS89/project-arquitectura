...
¡Estamos deseando empezar un proyecto contigo!</p>
            ...
            <div className="contacto-dire-mail">
                <div className="dire-container">
                    <Infocontacto texto = {'Av. Colon 850 - San Miguel de Tucumán - Tucumán'} referencia = {'direccion'}/>
                    <Infocontacto texto = {'(0381) - 4626971'} referencia = {'telefono'}/>
                    <Infocontacto texto = {'Lunes-Viernes: 09:00 a 20:00 Hrs / Sábados: 09:00 a 12:00 Hrs'} referencia = {'horario'}/>
                </div>
